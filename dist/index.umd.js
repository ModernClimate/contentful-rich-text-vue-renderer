(function (global, factory) {
  ...
  (global = global || self, global.ContentfulRichText = factory());
  ...
  var defaultMarkRenderers = (_defaultMarkRenderers = {}, _defineProperty(_defaultMarkRenderers, richTextTypes_es5_4.BOLD, function (children, key, h) {
    return h('strong', {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, richTextTypes_es5_4.ITALIC, function (children, key, h) {
    return h('em', {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, richTextTypes_es5_4.UNDERLINE, function (children, key, h) {
    return h('u', {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, richTextTypes_es5_4.CODE, function (children, key, h) {
    return h('code', {
      key: key
    }, children);
  }), _defaultMarkRenderers);
  var defaultNodeRenderers = (_defaultNodeRenderers = {}, _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.PARAGRAPH, function (node, key, h, next) {
    return h('p', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_1, function (node, key, h, next) {
    return h('h1', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_2, function (node, key, h, next) {
    return h('h2', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_3, function (node, key, h, next) {
    return h('h3', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_4, function (node, key, h, next) {
    return h('h4', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_5, function (node, key, h, next) {
    return h('h5', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HEADING_6, function (node, key, h, next) {
    return h('h6', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.EMBEDDED_ENTRY, function (node, key, h, next) {
    return h('div', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.UL_LIST, function (node, key, h, next) {
    return h('ul', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.OL_LIST, function (node, key, h, next) {
    return h('ol', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.LIST_ITEM, function (node, key, h, next) {
    return h('li', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.QUOTE, function (node, key, h, next) {
    return h('blockquote', {
      key: key
    }, next(node.content, key, h, next));
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_2.HR, function (_node, key, h) {
    return h('hr', {
      key: key
    }, {});
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_3.ASSET_HYPERLINK, function (node, key, h) {
    return defaultInline(richTextTypes_es5_3.ASSET_HYPERLINK, node, key, h);
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_3.ENTRY_HYPERLINK, function (node, key, h) {
    return defaultInline(richTextTypes_es5_3.ENTRY_HYPERLINK, node, key, h);
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_3.EMBEDDED_ENTRY, function (node, key, h) {
    return defaultInline(richTextTypes_es5_3.EMBEDDED_ENTRY, node, key, h);
  }), _defineProperty(_defaultNodeRenderers, richTextTypes_es5_3.HYPERLINK, function (node, key, h, next) {
    return h('a', {
      key: key,
      attrs: {
        href: node.data.uri
