...
const defaultMarkRenderers = {
    [richTextTypes_es5_4.BOLD]: (children, key, h) => h('strong', { key }, children),
    [richTextTypes_es5_4.ITALIC]: (children, key, h) => h('em', { key }, children),
    [richTextTypes_es5_4.UNDERLINE]: (children, key, h) => h('u', { key }, children),
    [richTextTypes_es5_4.CODE]: (children, key, h) => h('code', { key }, children)
};

const defaultNodeRenderers = {
    [richTextTypes_es5_2.PARAGRAPH]: (node, key, h, next) => (
        h('p', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_1]: (node, key, h, next) => (
        h('h1', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_2]: (node, key, h, next) => (
        h('h2', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_3]: (node, key, h, next) => (
        h('h3', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_4]: (node, key, h, next) => (
        h('h4', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_5]: (node, key, h, next) => (
        h('h5', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HEADING_6]: (node, key, h, next) => (
        h('h6', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.EMBEDDED_ENTRY]: (node, key, h, next) => (
        h('div', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.UL_LIST]: (node, key, h, next) => (
        h('ul', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.OL_LIST]: (node, key, h, next) => (
        h('ol', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.LIST_ITEM]: (node, key, h, next) => (
        h('li', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.QUOTE]: (node, key, h, next) => (
        h('blockquote', { key }, next(node.content, key, h, next))
    ),
    [richTextTypes_es5_2.HR]: (_node, key, h) => h('hr', { key }, {}),
    [richTextTypes_es5_3.ASSET_HYPERLINK]: (node, key, h) =>
        defaultInline(richTextTypes_es5_3.ASSET_HYPERLINK, node, key, h),
    [richTextTypes_es5_3.ENTRY_HYPERLINK]: (node, key, h) =>
        defaultInline(richTextTypes_es5_3.ENTRY_HYPERLINK, node, key, h),
    [richTextTypes_es5_3.EMBEDDED_ENTRY]: (node, key, h) =>
        defaultInline(richTextTypes_es5_3.EMBEDDED_ENTRY, node, key, h),
    [richTextTypes_es5_3.HYPERLINK]: (node, key, h, next) => {
        return h(
            'a',
            {
                key,
